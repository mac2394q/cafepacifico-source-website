...
// * or when using nginx (autodetect fails)
 ...
 $app ="cafepacifico";
 $dominio = "http://cafepacifico.ml";
 //$dominio = "http://localhost/credito";
 $dominio_server = "http://cafepacifico.ml";
...
$basename="portalxn_cafepacifico";
$host="192.185.128.14";
$userDatabase="portalxn_admin";
$passDatabase="f11235813";
$directorioNoFoundImage = "http://aesbeta.ml/vendor/aes/notfound.png";
...
if (!defined('CORE_JS_SERVER')) define('CORE_JS_SERVER',  DOMAIN_PATH.'core/');

if (!defined('CORE_JS_PATH')) define('CORE_JS_PATH',   ROOT_PATH.'core/');
...
if (!defined('WEB_PATH')) define('WEB_PATH', VIEW_PATH.'web/');

if (!defined('WEB_SERVER')) define('WEB_SERVER', VIEW_SERVER.'web/');
