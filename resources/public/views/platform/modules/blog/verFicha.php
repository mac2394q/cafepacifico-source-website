...
<body class="vertical-layout vertical-menu-modern material-vertical-layout material-layout 2-columns   fixed-navbar"
    ...
    <input type="hidden" value="<?php echo $_GET['id'];?>" name="idblog" />
    <!-- fixed-top-->
    <?php
    ...
    $url1 = DOCUMENTS_SERVER."blog/".$idElemento."/introduccion.jpg";
    $url2 = DOCUMENTS_SERVER."blog/".$idElemento."/contenido.jpg";
    $url3 = DOCUMENTS_SERVER."blog/".$idElemento."/cabecera.jpg";
  ...
  ?>
    ...
    <script src="<?php echo PLATFORM_SERVER."modules/blogs/triggers/module.js"; ?>"></script>
    <script>
