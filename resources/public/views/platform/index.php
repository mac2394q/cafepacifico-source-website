      ...
      <div class="content-header-dark bg-img col-12">
        <div class="row">
          <div class="content-header-left col-md-9 col-12 mb-2">
            <h3 class="content-header-title white"><i class="fa fa-mail-bulk"></i> Panel de control </h3>
            <div class="row breadcrumbs-top">
              <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item active">Area de notificaciones 
                  </li>
                            ...
                            <div class="row">
                              <div class="col-sm-12">
                                <div id="tablaDinamica_panel">
                                  <?php reservacionController::listadoReservacion(); ?>
                                </div>
                              </div>
                            </div>
                          </div>
