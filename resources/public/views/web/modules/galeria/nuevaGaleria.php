...
<body>
            ...
            <div class="row">
                ...
                <div class="col-md-8 col-sm-8">
                    ...
                    <div id="addcomment" class="blog-comment-form-main">
                        <h5 class="widget-title margin-five no-margin-top">Agregar nueva galeria</h5>
                        <div class="blog-comment-form">
                            <form>
                                ...
                                <textarea name="textarea2" id="textarea2" placeholder="Resumen"></textarea>

                               

                                <span class="required">*Por favor complete todos los campos correctamente</span>

                                <button id="registrarGaleria"
                                    class="highlight-button-dark btn btn-small no-margin-bottom">Nueva galeria
                                </button>
                                <br><br>
                                <div id="smgBlog">
    ...
    <script>
        ...
        $(document).on('click', '#registrarGaleria', function (e) {
            $("#smgElemento").html("");
            ...
            var ruta = routesAppWeb() + 'galeria/core/registrarGaleria.php';
